...
function Detail() {
    ...
    return (
        <section className='grid grid-cols-2 mt-[74px] gap-[91px] 2xl:gap-0 2xl:mb-10'>
            <div key={productDetail.Id} className='flex flex-row w-[610px] h-[461px] gap-3'>
                <img src={productDetail.Imagen} alt={productDetail.Nombre} className=' rounded-[10px] object-cover h-[461px] w-[622px] shadow-[0_4px_3px_0_rgba(0,0,0,0.25)]' />
            </div>
            <div className=' '>
                ...
                <p className='text-general text-2xl font-bold'>$ {productDetail.Precio - (productDetail.Precio*0.2)}</p>
