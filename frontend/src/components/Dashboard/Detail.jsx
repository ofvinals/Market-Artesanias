...
export const Detail = () => {
	...
	return (
		<>
			<div className='bg-portada min-h-[150px] bg-cover flex flex-col pr-3 '>
				<div className='w-full flex items-center justify-center h-20 '>
					<h3 className='text-3xl font-bold text-general text-center'>
				...
				<div className='w-full flex flex-row items-center justify-center mx-3 flex-wrap'>
					<button
						className='bg-specific text-white text-center px-4 py-2 mt-4 sm:me-4 rounded-md w-[260px] h-[44px] mb-10  hover:bg-white hover:text-specific hover:border-specific hover:border-2'
					...
					<button
						className='bg-specific text-white text-center px-4 py-2 mt-4  rounded-md w-[260px] h-[44px] mb-10  hover:bg-white hover:text-specific hover:border-specific hover:border-2'
