...
function AboutUsCard({ id, name, role, image, description, linkedin, email }) {
    return (
        <article key={id} className='flex flex-col md:flex-row w-full md:h-full  md:w-[608px]  border-2 border-specific rounded-[10px] md:p-6   gap-6'>
            ...
            <div className='pl-3 pr-3 mb-3'>
                ...
                <p className='text-general text-xs md:text-sm text-balance  '>{description}</p>
            </div>
        </article>
    )
}
