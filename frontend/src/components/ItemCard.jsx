	...
	return (
        <article className="flex flex-col border w-[296px] h-[261px] rounded-[10px] shadow-[0_4px_3px_0_rgba(0,0,0,0.25)] hover:scale-110 hover:transition-all">
            <Link to={`/${id}`}>
                ...
                <div className="pl-5 pr-5 pt-3 pb-2 bg-[#D9D9D94A]">
                    <h2 className='text-xl font-bold text-general truncate'>{name}</h2>
                    <p className="text-general truncate">{description}</p>
